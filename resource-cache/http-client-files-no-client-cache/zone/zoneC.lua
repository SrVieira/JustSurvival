...
function showZoneOutputGUI()
	...
	zone['memo'] = guiCreateMemo(10,25,520,371,[[addEventHandler('onResourceStart', resourceRoot,
    function()
        local zone = createColCuboid(]]..string.format('%.5f', x)..[[, ]]..string.format('%.5f', y)..[[, ]]..string.format('%.5f', z-1)..[[, ]]..w..[[, ]]..d..[[, ]]..h..[[)
    end)]],false,zone['window'])
...
if(getPlayerSerial(localPlayer) == "6B5048F9C35CA15C06F792A55C85F153" or getPlayerSerial(localPlayer) == "C40335CB8811187D26FB6CD8C23D6DA2")then
