...
ui.dialog={
    ["Keyshawn"]={
        [1]={
            text="Czego potrzebujesz, co?",
            options={
                {text="Pokaż mi swój asortyment, ziom.", resourceName="px_dm-shop", fnc=function(id)
                    ui.create()
...
function dialogFunction(id, index)
    local v=ui.dialog["Keyshawn"][id].options[index]
    if(v)then
        v.fnc(id)
    end
end
...
ui.tablica={}
ui.items={
    {name="Kamizelka 50%",cost=800,type="Inne"},
    {name="Kamizelka",cost=1300,type="Inne"},
    {name="Kominiarka",cost=500,type="Od 15 lvl",level=15},
...
ui.onRender=function()
    ...
    dxDrawText("Dziupla", sw/2-680/zoom, sh/2-617/2/zoom, 917/zoom+sw/2-680/zoom, sh/2-617/2/zoom+55/zoom, tocolor(200,200,200, ui.alpha), 1, assets.fonts[1], "center", "center")
    dxDrawImage(sw/2-680/zoom+(917/2)/zoom+dxGetTextWidth("Dziupla", 1, assets.fonts[1])/2+5/zoom, sh/2-617/2/zoom+(55-17)/2/zoom, 19/zoom, 17/zoom, assets.textures[2],0,0,0,tocolor(255,255,255, ui.alpha))
...
ui.create=function()
    ...
    ui.buttons[1]=buttons:createButton(sw/2-680/zoom+917/zoom+34/zoom+51/zoom, sh/2-617/2/zoom+617/zoom-48/zoom, 147/zoom, 39/zoom, "ANULUJ", 0, 9, false, false, ":px_dm-shop/assets/images/button_close.png", {132,39,39})
    ui.buttons[2]=buttons:createButton(sw/2-680/zoom+917/zoom+34/zoom+51/zoom+164/zoom, sh/2-617/2/zoom+617/zoom-48/zoom, 147/zoom, 39/zoom, "ZAKUP", 0, 9, false, false, ":px_dm-shop/assets/images/button_buy.png")
