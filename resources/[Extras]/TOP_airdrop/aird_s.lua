...
function initAirdrop()
	...
	outputChatBox("[DROP] Un avion dejará un paquete en la zona de "..getZoneName(x, y, z, false).." en "..getZoneName(x, y, z, true), root, 255, 100, 100, false)
	
	droppingBlip = createBlip(x, y, z, 56, 3)
	setElementData(droppingBlip, "customIcon", ":"..getResourceName(getThisResource()).."/blip.png")
